...
from schema.auth_schema import User, Payload, SignIn, SignUp
from schema.user_schema import FindUser, BaseUserWithPassword
...
class AuthService(BaseService):
    ...
    def sign_up(self, user_info: SignUp):
        ...
        user = BaseUserWithPassword(**user_info.model_dump(exclude_none=True), is_active=True, is_superuser=False)  # user_token=user_token
