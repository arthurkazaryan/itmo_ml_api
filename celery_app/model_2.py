...
model = pickle.load(open(Path("celery_app/dump/model_2/xgb.mdl"), 'rb'))


@app.task(name='model_2')
def model_2(user_id: int, n_days: int, drug: str, age: int, sex: str, ascites: str, hepatomegaly: str,
...
@task_success.connect(sender=model_2)
...
@task_failure.connect(sender=model_2)
